...
class EgLayoutScreen extends StatefulWidget {
   final CountryModel? countryModel;
   const EgLayoutScreen({Key? key,this.countryModel}) : super(key: key);

  @override
  State<EgLayoutScreen> createState() => _EgLayoutScreenState();
}

class _EgLayoutScreenState extends State<EgLayoutScreen> {
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          Duration(milliseconds: 500),
            ...
            child:
            // widget.countryModel?.text == 'Eg' ?
            cubit.egScreens[cubit.currentIndex]
                // :
