...
import 'ar_science_grid-builder.dart';
import 'ar_science_list_builder.dart';

class ArScienceScreen extends StatefulWidget {
  const ArScienceScreen({super.key});

  @override
  State<ArScienceScreen> createState() => _EgScienceScreenState();
}

class _EgScienceScreenState extends State<ArScienceScreen> {
  ...
  tabScienceOnToggleShow() =>
      ...
      const Padding(
        ...
        child: ArScienceListBuilder(),
      )
          : cubit.tabScienceIndexToggle.value == 1
          ?
      const Padding(
        padding: EdgeInsets.symmetric(horizontal: 0),
        child: ArScienceGridBuilder(),
      )
